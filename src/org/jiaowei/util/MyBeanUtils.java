...
//          String type = origDescriptors[i].getPropertyType().toString();
    ...
    public static void copyBeanNotNull2Map(Object databean, Map<String, Object> map) throws Exception {
        PropertyDescriptor origDescriptors[] =
                PropertyUtils.getPropertyDescriptors(databean);
        for (int i = 0; i < origDescriptors.length; i++) {
            String name = origDescriptors[i].getName();
//          String type = origDescriptors[i].getPropertyType().toString();
    ...
    public static void copyBeanNotNullAndId2Map(Object databean, Map<String, Object> map) throws Exception {
        PropertyDescriptor origDescriptors[] =
                PropertyUtils.getPropertyDescriptors(databean);
        for (int i = 0; i < origDescriptors.length; i++) {
            String name = origDescriptors[i].getName();
//          String type = origDescriptors[i].getPropertyType().toString();
    ...
    public static void copyBeanNotNullAndId2MapNoString(Object databean, Map<String, Object> map) throws Exception {
        PropertyDescriptor origDescriptors[] =
                PropertyUtils.getPropertyDescriptors(databean);
        for (int i = 0; i < origDescriptors.length; i++) {
            String name = origDescriptors[i].getName();
...
//            System.out.println(type);
            if ("class".equals(name) || "id".equals(name) || type.contains("java.lang.String")) {
                continue; // No point in trying to set an object's class
            }
            if (PropertyUtils.isReadable(databean, name)) {
                try {
    ...
    public static void copyBeanNotNullAndId2MapWithString(Object databean, Map<String, Object> map) throws Exception {
        PropertyDescriptor origDescriptors[] =
                PropertyUtils.getPropertyDescriptors(databean);
        for (int i = 0; i < origDescriptors.length; i++) {
            String name = origDescriptors[i].getName();
...
//                        value = new Timestamp(Long.valueOf(value.toString()) * 1000);
                        //TODO:
                        continue;
                    }
                }
...
//        map.put("toUserName","ToUserName-value");
//        map.put("fromUserName","FromUserName-value");
//        map.put("createTime",123456);
//        map.put("msgType","text-value");
//        map.put("msgId","MsgId-value");
//        //==================================================
//        MsgBaseEntity  mbe = new MsgBaseEntity();
//
////        System.out.println(getMappedProperty(mbe, "ToUserName"));
////        String  temp = getSimpleProperty(mbe, "ToUserName");
////        System.out.println(temp);
//        MyBeanUtils.copyMap2Bean(mbe, map);
