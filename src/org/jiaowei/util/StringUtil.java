...
public class StringUtil {
    ...
    public static String tel2String(String tel) {
        if (StringUtil.isEmpty(tel)) {
            return null;
        }
        StringBuffer sb = new StringBuffer();
        for (int i = 0; i < tel.length(); i++) {
//			Integer.valueOf(tel.charAt(i)).toh
//            System.out.println(tel.charAt(i));
            sb.append(Integer.toHexString(Integer.valueOf(tel.charAt(i)).intValue()));
//            System.out.println(sb.toString());
//            System.out.println(tel.getBytes());
        }
        return sb.toString();
    }
    ...
    public static String stringToAscii(String value) {
        ...
        for (int i = 0; i < chars.length; i++) {
            sbu.append(Integer.toHexString(((int) chars[i]) + i + 14));
        }
    ...
    public static String asciiToString(String value) {
        ...
        for (int i = 0; i < value.length() / 2; i++) {
            ...
            int tmpInt = Integer.parseInt(tmp, 16) - i - 14;
            sbu.append((char) tmpInt);
        }
        return sbu.toString();
    }
...
//		String  source="this#a#goodasdfasfd#BBBB#casdfasdfe";
//		System.out.println(tel2String("18702319187"));
//		System.out.println("======================");
//		System.out.println(Integer.parseInt("3f",16));
//      System.out.println(Integer.toHexString(1));
        System.out.println("**********************");
        System.out.println(stringToAscii("18523031212"));
        System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
        System.out.println(asciiToString("3f4747414446454e474f4f"));
    }
}
