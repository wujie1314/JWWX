...
//					result.put(key, list);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> void mapToList(Map<String, Object> retObject, List<?> objList, Class<?> zclass) throws InstantiationException, IllegalAccessException, InvocationTargetException {
	...
	@SuppressWarnings("unchecked")
	public static <T> List<?> mapToBeanList(Map<String, Object> map, Class<?> clazz) throws InstantiationException, IllegalAccessException, InvocationTargetException {
		List<T> result = null;
