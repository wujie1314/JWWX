...
<body style="background: #fff;">
	<div class="container">
        ...
        <ul id="imgUl" class="wx01-second overflow" style="padding-bottom: 0px;">
            <li>
                <dl>
                    <dt class="overflow">
                        <img class="big-pic" style="height:130px" src="${ctx}/image/road/05-01.png"/>
                        <div class="bg"></div>
	...
	function fillAjaxData(data){
		...
		$.each(data, function(i,vide) {
			...
			//if(isCollect == 1){
				//ul += "<li><dl><dt><img style=\"height:130px\" class=\"big-pic wx-switch-img\" src=\""+vide.videUrl+"\"><div class=\"bg\"></div><p class=\"text\">"+showName+"</p></dt><dd onclick='cancelCollent("+vide.videId+")'><img src=\"${ctx}/image/road/01-xin-icon.png\"><span>"+vide.collectNum+"</span></dd></dl></li>";
			//} else {
				//ul += "<li><dl><dt><img style=\"height:130px\" class=\"big-pic wx-switch-img\" src=\""+vide.videUrl+"\"><div class=\"bg\"></div><p class=\"text\">"+showName+"</p></dt><dd onclick='certainCollent("+vide.videId+")'><img src=\"${ctx}/image/road/01-xin-icon1.png\"><span>"+vide.collectNum+"</span></dd></dl></li>";
			//}
