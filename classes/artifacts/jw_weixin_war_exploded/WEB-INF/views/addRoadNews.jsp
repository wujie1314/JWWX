...
<body>
	<div class="page" id="opretor">
		...
		<input type="hidden" name="createMan" value="${sign.openid}">
		...
		<div class="weui_cells weui_cells_form">
			<div class="weui_cell">
				...
				<div class="weui_cell_bd weui_cell_primary">
					<input class="weui_input" name="title" type="text"
						placeholder="请输入标题" />
				</div>
			</div>
			<div class="weui_cell">
				...
				<div class="weui_cell_bd weui_cell_primary">
					<input class="weui_input" name="address" readonly="true"
			...
			<div class="weui_cells weui_cells_form">
				<div class="weui_cell">
					<div class="weui_cell_bd weui_cell_primary">
						<textarea name="content" onkeydown="showContentNum(this);"
							class="weui_textarea" placeholder="请输入具体情况" rows="3"></textarea>
							...
							<div class="weui_uploader_bd">
								...
								<div class="weui_uploader_input_wrp">
									<input class="weui_uploader_input" type="file"
										onclick="chooseImage();return false;"
...
function geocoder(latitude,longitude){
    $.ajax({
		...
		success : function(data) {
	        $("input[name=address]").val(data.result.formatted_address);
        },
		error:function(data){
		}
	});
...
function saveSblkInfo(){
    ...
    var createMan=$("input[name=createMan]").val();
    var address=$("input[name=address]").val();
    var title=$.trim($("input[name=title]").val());
    var content=$.trim($("textarea[name=content]").val());
    if(title==""){
    	$("input[name=title]").focus();
		openDialog("dialog2","标题不能为空");
    	return false;
    }else if(content==""){
    	$("textarea[name=content]").focus();
		openDialog("dialog2","内容不能为空");
    	return false;
    }
    var imageSrc="";
...
function showSBLKRoadNews() {
	window.location.href="../reportRoadNews.jsp?openId=${sign.openid}";
}
</script>
</html>