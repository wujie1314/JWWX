...
<body>
	<div class="container">
		<div class="top_bar">
			<img onclick="onBack('${type}')" class="back_img" src="${ctx}/image/park/back_new.png">
...
function onBack(type){
	if(type == 4 || type ==5 || type == 6 || type == 7 || type == 8){
		location.href ="${ctx}/newParkNextInfo.jsp";	
	} else {
		location.href ="${ctx}/newParkInfo.jsp";	
	}
}
function onDetails(type){
	location.href ="${ctx}/newParkDetailInfo.jsp?type="+type;
}
</script>
</html>