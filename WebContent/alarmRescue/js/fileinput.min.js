...
function(e) {
    ...
    i.prototype = {
        ...
        _initTemplateDefaults: function() {
            ...
            h = '<button type="button" class="kv-file-remove {removeClass}" style="float:right;" onclick="deleteFile();" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}<img src="alarmRescue/img/icon_fork.png" class="icon_fork "/></button>\n',
        ...
        _renderButton: function(e) {
            ...
            t.isEmpty(l) || (l = ' <span class="' + i.buttonLabelClass + '" >' + "<img src='alarmRescue/img/upload.png'>" + "</span>"),
            a.setTokens({
                type: d,
                css: r,
                title: n,
    ...
    e.fn.fileinputLocales.en = {
        ...
        msgNo: "No",
        msgNoFilesSelected: "没有文件选中",
        msgCancelled: "Cancelled",
        msgPlaceholder: "选择文件...",
        msgZoomModalHeading: "细节查看",
        ...
        msgInvalidFileExtension: '非法文件 "{name}". 只有 "{extensions}" 文件支持.',
        msgFileTypes: {
            image: "image",
            html: "HTML",
            text: "text",
