...
function hrefIntroduce(){
	location.href="${ctx}/meeting/introduce2";
}
function hrefAgenda(){
	location.href="${ctx}/meeting/agenda2";
}
function hrefSeats(){
	location.href="${ctx}/meeting/seats2";
}
function hrefUser(){
	location.href="${ctx}/meeting/user2";
}
function hrefDatum(){
	location.href="${ctx}/meeting/datum2";
}
function hrefServiceCenter(){
	location.href="${ctx}/meeting/serviceCenter2";
}
